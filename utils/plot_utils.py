    ...
    for i in range(Numb_Algs):
        ...
        if(algorithms_list[i] == "pFedMe" or algorithms_list[i] == "pFedMe_p"):
            algorithms_list[i] = algorithms_list[i] + "_" + string_learning_rate + "_" + str(num_users) + "u" + "_" + str(
                batch_size[i]) + "b" + "_" + str(loc_ep1[i]) + "_" + str(k[i]) + "_" + str(personal_learning_rate[i])
        else:
            algorithms_list[i] = algorithms_list[i] + "_" + string_learning_rate + "_" + str(
                num_users) + "u" + "_" + str(batch_size[i]) + "b"  "_" + str(loc_ep1[i]) + "_" + str(k[i])
...
def average_data(num_users=100, loc_ep1=5, Numb_Glob_Iters=10, lamb="", learning_rate="", beta="", algorithms="", batch_size=0, dataset="", k="", personal_learning_rate="", times=5, cutoff=0):
    ...
    glob_acc, train_acc, train_loss, avg_acc = get_all_training_data_value(
        num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms, batch_size, dataset, k, personal_learning_rate, times, cutoff)
    ...
    alg = alg + "_" + str(learning_rate) + "_" + str(beta) + "_" + str(lamb) + "_" + str(
        num_users) + "u" + "_" + str(batch_size) + "b" + "_" + str(loc_ep1) + "_" + str(k)
    if(algorithms == "pFedMe" or algorithms == "pFedMe_p"):
...
def plot_summary_one_figure(num_users=100, loc_ep1=5, Numb_Glob_Iters=10, lamb=[], learning_rate=[], beta=[], algorithms_list=[], batch_size=0, dataset="", k=[], personal_learning_rate=[]):
    ...
    glob_acc_, train_acc_, train_loss_ = get_training_data_value(
        num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate)
    ...
    ) + str(loc_ep1[1]) + 'train_acc.png', bbox_inches="tight", pad_inches=0)
    #plt.savefig(dataset + str(loc_ep1[1]) + 'train_acc.pdf')
    plt.figure(2)

    plt.grid(True)
    for i in range(Numb_Algs):
        plt.plot(train_loss[i, start:],
                 linestyle=linestyles[i], label=algorithms_list[i])
    ...
    plt.savefig(dataset.upper(
    ) + str(loc_ep1[1]) + 'train_loss.png', bbox_inches="tight", pad_inches=0)
    ...
    plt.title(dataset.upper())
    plt.savefig(dataset.upper(
    ) + str(loc_ep1[1]) + 'glob_acc.png', bbox_inches="tight", pad_inches=0)
...
def plot_summary_human_activity_eta(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate):
    ...
    glob_acc_, train_acc_, train_loss_, glob_acc_avg_ = get_training_data_value(
        num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate)
    ...
    lamb = [r'$: \eta = $' + r'$10^{-3}$', r'$: \eta = $' + r'$10^{-2}$',
            r'$: \eta = $' + r'$10^{-1}$', r'$: \eta = $' + r'$1$', "", "", ""]
    algorithms = ["FedU", "FedU", "FedU", "FedU", "Local", "Global", "MOCHA"]
    linestyles = ['-', '-', '-', '-', ':', '--', '-.']
    markers = ["d", "p", "v", "s", "x", "*", "o"]
    colors = ['tab:blue', 'tab:green', 'r',
              'darkorange', 'tab:brown', 'm', 'slategray']
    ...
    marks = []
    for i in range(Numb_Algs):
        plt.plot(train_loss[i, 1:], linestyle=linestyles[i], label=algorithms[i] + lamb[i],
    ...
    plt.ylabel('Training Loss')
    plt.xlabel('Global rounds')
    plt.savefig(dataset.upper() + "_eta_train_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.figure(2, figsize=(5, 5))
    plt.grid(True)
    plt.title(r'$\alpha$' + "-strongly convex")
    for i in range(Numb_Algs):
        plt.plot(glob_acc_avg[i, 1:], linestyle=linestyles[i], label=algorithms[i] + lamb[i],
                 linewidth=1, color=colors[i], marker=markers[i], markevery=0.2, markersize=5)
    plt.legend(loc='lower right', prop={'size': 12}, ncol=2)
    plt.ylabel('Test Accuracy')
    plt.xlabel('Global rounds')
    plt.ylim([0.7,  0.935])  # non convex-case
    plt.savefig(dataset.upper() + "_eta_test_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.close()
...
def plot_summary_human_activity_akl(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate):
    ...
    for i in range(Numb_Algs):
        if(k[i] == 0):
            ...
            alk = r'$: a_{kl} = $' + "R"
        plt.plot(train_loss[i, 1:], linestyle=linestyles[i], label=algorithms[i] + alk,
                 linewidth=1, color=colors[i], marker=markers[i], markevery=0.2, markersize=5)
    plt.legend(loc='upper right', prop={'size': 12})
    plt.ylim([0.07,  0.5])
    plt.ylabel('Training Loss')
    plt.xlabel('Global rounds')
    plt.savefig(dataset.upper() + "_akl_train_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.figure(2, figsize=(5, 5))
    plt.grid(True)
    plt.title(r'$\alpha$' + "-strongly convex")
    for i in range(Numb_Algs):
        if(k[i] == 0):
            ...
            alk = r'$: a_{kl} = $' + "R"
        plt.plot(glob_acc_avg[i, 1:], linestyle=linestyles[i], label=algorithms[i] + alk,
                 linewidth=1, color=colors[i], marker=markers[i], markevery=0.2, markersize=5)
    plt.legend(loc='lower right', prop={'size': 12})
    plt.ylabel('Test Accuracy')
    plt.xlabel('Global rounds')
    plt.ylim([0.77,  0.94])  # non convex-case
    plt.savefig(dataset.upper() + "_akl_test_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.close()
...
def plot_summary_human_activity_akl_non(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate):
    ...
    plt.ylabel('Training Loss')
    plt.xlabel('Global rounds')
    plt.savefig(dataset.upper() + "_akl_train_non_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.figure(2, figsize=(5, 5))
    plt.grid(True)
    ...
    plt.savefig(dataset.upper() + "_akl_test_non_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.close()
...
def plot_summary_mnist_eta(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate):
    ...
    lamb = [r'$: \eta = $' + r'$10^{-3}$', r'$: \eta = $' + r'$5.10^{-3}$',
            r'$: \eta = $' + r'$10^{-2}$', r'$: \eta = $' + r'$5.10^{-2}$', "", "", ""]
    algorithms = ["FedU", "FedU", "FedU", "FedU", "Local", "Global", "MOCHA"]
    linestyles = ['-', '-', '-', '-', ':', '--', '-.']
    markers = ["d", "p", "v", "s", "x", "*", "o"]
    colors = ['tab:blue', 'tab:green', 'r',
...
def plot_summary_mnist_eta_non(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta, algorithms_list, batch_size, dataset, k, personal_learning_rate):
    ...
    plt.savefig(dataset.upper() + "_eta_train_non_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.figure(2, figsize=(5, 5))
    plt.grid(True)
    #plt.title(r'$\alpha$'+  "-strongly convex")
    ...
    plt.savefig(dataset.upper() + "_eta_test_non_convex.pdf",
                bbox_inches="tight", pad_inches=0)
    plt.close()
