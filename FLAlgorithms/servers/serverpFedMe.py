...
class pFedMe(Server):
    def __init__(self, experiment, device, dataset, algorithm, model, batch_size, learning_rate, beta, L_k, num_glob_iters,
                 local_epochs, num_users, K, personal_learning_rate, times, cutoff):
        ...
        for i in range(total_users):
            ...
            user = UserpFedMe(device, id, train, test, model, batch_size, learning_rate,
                              beta, L_k, local_epochs, K, personal_learning_rate)
    ...
    def save_results1(self):
        ...
        rs_file_path = RS_PATH + \
            "{}_{}_I{}.h5".format(DATASETS[2], "pFedMe", Global_rounds[2])
        print(rs_file_path)
